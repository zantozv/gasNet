...
return [
    ...
    */
    ...
    'logo' => 'Gas<b>NET</b>',
    'logo_img' => 'vendor/adminlte/dist/img/favicon.gif',
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Ciudades',
            'route'  => 'ciudad.index',
            'icon'   => 'far fa-fw fas fa-city',
            'can' =>'admin.ciudades.index'
           
        ],
        [
            'text' => 'Tipos de servicio',
            'route'  => 'tiposervicio.index',
            'icon'   => 'far fa-fw fas fa-hammer',
            'can' =>'admin.tiposervicios.index'
        ...
        [
            'text' => 'Requisitos',
            'route'  => 'requisito.index',
            'icon'   => 'far fa-fw fas fa-check',
            'can' =>'admin.requisitos.index',
            'label'  => 'Importante',
            'label_color' => 'warning'           
        ],
